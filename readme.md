...
本次设计基于**ESP32-C3 Wi-Fi/BLE双模SoC**，其蓝牙子系统通过 **Bluetooth LE 5.4** 认证（QDID: 176318），支持最新核心规范：
...
本系统核心功耗源为ESP32-C3主控芯片及OLED 12864显示屏。在3.3V工作电压下：
...
考虑实际电路损耗（含LDO转换效率、PCB走线损耗、电容漏电流等），引入15%冗余系数：
